...
@section('content')
  ...
  @include('layouts.site.header')
	<section>
		<div class="container">
			<div class="row">
				@if($message = Session::get('flash_message_success_cart')) 
				...
				@endif
				@if($message = Session::get('flash_message_success_wishlist')) 
					<div class="alert alert-success"  role="alert">
						<span type="button" class="close" style="margin:0" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></span>
						    {{ $message }}
					</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<span>
			                        ...
			                        @elseif($message = Session::get('flash_message_success_wishlist')) 
			                        <a href="{{ url('/wishlist') }}" class="btn btn-default cart"><i class="fa fa-arrow-right" aria-hidden="true"></i>Go to wishlist</a>
									@else
