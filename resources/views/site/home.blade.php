      ...
      <div class="row">
        <div class="col-sm-12">
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <h1 style="color: #B4B1AB; font-weight: 300"><span style="color: #fe980f">Hello!! {{ Auth::user()->firstname }},</span>Welcome to our site!!</h1>
                      ...
                      <div class="product-image-wrapper">
                        ...
                        <div class="choose">
                          <ul class="nav nav-pills nav-justified">
                            <li><a href="{{ url('/product/'.$pro->id) }}"><i class="fa fa-plus-square"></i>Add to wishlist</a></li>
          ...
          <div class="category-tab"><!--category-tab-->
            <div class="col-sm-12">
              <ul class="nav nav-tabs">
                @foreach($categories as $cat)
                  <li class="@if($loop->first) active in @endif"><a href="#{{ $cat->id }}" data-toggle="tab">{{ $cat->category }}</a></li>
                @endforeach
              </ul>
            </div>
            <div class="tab-content">
              @foreach($categories as $cat)
              <div class="tab-pane @if($loop->first) active in @endif" id="{{ $cat->id }}">
                @foreach($cat->products->take(4) as $pro)
                  <div class="col-sm-3">
                    <div class="product-image-wrapper">
                      <div class="single-products">
                        <div class="productinfo text-center">
                            <img src="{{ url('../uploads/productimages/'.$pro->product_images[0]->image) }}" alt="" style="width: 75%" height="200" />
                          <h2>{{ $pro->price }}</h2>
                          <p>{{ $pro->name }}</p>
                          <a href="{{ url('/product/'.$pro->id) }}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                        </div>
