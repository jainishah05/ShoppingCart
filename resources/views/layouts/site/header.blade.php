          ...
          <div class="col-sm-6">
            ...
            @auth
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> {{ Auth::user()->mobile }}</a></li>
          ...
          <div class="col-sm-8">
            <div class="shop-menu pull-right">
              <ul class="nav navbar-nav">
                <li>
                    @guest
                      <a href="{{ route('wishlist') }}"><i class="fa fa-star"></i> Wishlist</a>
                    @else
                      @if(Cart::instance('wishlist')->count() > 0)
                        <span class="wishlist-badge">{{ Cart::instance('wishlist')->count() }}</span>
                      @endif
                        <a href="{{ route('wishlist') }}"><i class="fa fa-star"></i> Wishlist</a>
                    @endguest
                </li>
        ...
        <div class="row">
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              ...
              @guest
                <li class="dropdown">
                  <a href="#" {{-- class="active" --}}>Shop<i class="fa fa-angle-down"></i></a>
