...
Route::group(['middleware' => ['auth']], function () {
	...
	//product
	Route::match(array('GET', 'POST'),'/product/{cat_id?}', 'Site\\ProductController@displayProducts')->name('display.product');
	//get filter value
	Route::get('/get-filter-value', 'Site\\ProductController@displayProducts');
	//get product price
	Route::get('/get-product-price', 'Site\\ProductController@getProductPrice');
